    ...
    <section className="relative py-16 sm:py-24 bg-[#111111]">
      <div className="mx-auto max-w-4xl px-6">
        ...
        <motion.div
          ...
          className="space-y-6 text-white/85 leading-relaxed"
        >
          <p>
          ...
          <p>
            ...
            를 완성했고, 2021년부터 주요 플랫폼과의 협업을 통해 전국
            네트워크를 확장했습니다.
          </p>
          ...
          <p>
            정산 앱{" "}
            <span className="font-semibold text-[#FFD966]">LogitEats</span>, 지역
            센터 운영, 바이크 렌트·리스, 파트너사 제휴까지 —{" "}
