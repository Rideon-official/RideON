      ...
      <div className="mx-auto max-w-7xl px-4 lg:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-12 mb-32 items-stretch">
          ...
          <div className="flex flex-col justify-between space-y-12">
            ...
            {/* 오른쪽에서 이동해온 최종 슬로건: 왼쪽 하단 배치로 무게중심 완성 */}
            <FadeUp delay={0.3}>
              <div className="pt-10 border-t border-white/10 max-w-md">
              ...
              <div className="grid gap-10 relative z-10">
                {[
                  ...
                  <motion.div 
                    ...
                    className="group"
                  >
                    <div className="text-white text-[17px] font-bold mb-2 group-hover:text-[#FFB800] transition-colors">{item.main}</div>
                    <div className="text-white/40 text-[14px] font-light leading-relaxed break-keep max-w-lg">{item.sub}</div>
                    <div className="mt-5 h-[1px] w-full bg-gradient-to-r from-white/10 to-transparent" />
                  </motion.div>
                ))}
              </div>

              {/* 장식용 ON 텍스트를 오른쪽 구석에 아주 은은하게 */}
