  ...
  return (
    <section className="relative py-32 border-t border-white/5 overflow-hidden">
      <div className="mx-auto max-w-7xl px-4 lg:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-8 mb-32 items-start">
          ...
          <div className="space-y-10">
            ...
            <div className="space-y-8">
              ...
              <FadeUp delay={0.1}>
                <p className="text-white/60 text-lg lg:text-[19px] font-light leading-[1.7] break-keep max-w-xl">
          ...
          {/* 오른쪽 절반: 솔루션 상세 (오른쪽 영역의 왼쪽 정렬로 꽉 채움) */}
          <FadeUp delay={0.2} className="w-full">
            <div className="relative p-1 lg:p-2">
              {/* 카드 형태가 아닌, 영역감을 주는 은은한 배경 */}
              <div className="absolute inset-0 bg-white/[0.02] rounded-[40px] blur-3xl -z-10" />
              ...
              <div className="grid gap-8 relative z-10">
                {[
                  ...
                  <motion.div 
                    ...
                    className="group"
                  >
                    <div className="text-white text-[17px] font-bold mb-1.5 group-hover:text-[#FFB800] transition-colors">{item.main}</div>
                    <div className="text-white/40 text-[14px] font-light leading-relaxed break-keep">{item.sub}</div>
              ...
              {/* 장식용 ON 텍스트를 오른쪽 하단으로 은은하게 */}
              <div className="absolute -right-4 -bottom-10 text-[140px] font-black text-white/[0.01] select-none pointer-events-none">
                ON
              </div>
            </div>
          </FadeUp>
