...
export default function Home() {
  return (
    <main className="bg-brand-dark min-h-screen text-white">
      ...
      <section id="hero" className="relative min-h-[85vh] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 lg:px-6 py-20 grid lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7">
            ...
            <FadeUp delay={0.2}>
              <Heading level={1} align="left" className="text-5xl md:text-6xl font-black tracking-tighter leading-tight">
                전국을 연결하는 <br />
            ...
            <FadeUp delay={0.3}>
              <BodyText className="mt-6 max-w-xl text-text-body text-lg leading-relaxed">
          ...
          {/* [우측] 비주얼 영역 (40%) - 지도가 절대 잘리지 않도록 설정 */}
          <div className="lg:col-span-5 relative hidden lg:flex justify-end items-center h-full">
            ...
            >
              <Image
                ...
                fill
                priority
                className="object-contain object-right opacity-80" // object-right로 우측 밀착
              />
      ...
      {/* ===== 하단 모든 섹션: 배경색 싹 지우고 첫 번째 색으로 통합 ===== */}
