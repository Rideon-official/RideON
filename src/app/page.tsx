...
export default function Home() {
  return (
    <main className="bg-brand-dark min-h-screen text-white">
      {/* ===== Section 1: Hero (세로 줄간격 디테일 최적화 버전) ===== */}
      <section id="hero" className="relative min-h-[95vh] flex items-start pt-32 lg:pt-52 overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-7xl w-full px-4 lg:px-6 grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          {/* [좌측] 텍스트 영역: 여백을 더 시원하게 벌림 */}
          <div className="flex flex-col m-0 p-0 border-none"> 
            <FadeUp delay={0.1}>
              <div className="mt-0 pt-0">
                {/* mb-10으로 제목과의 간격을 시원하게 벌림 */}
                <Eyebrow className="text-brand-accent font-black tracking-wider text-xs lg:text-sm mt-0 pt-0 py-[2px] leading-none inline-block mb-10">
                  전국 라이더 운영 인프라
                </Eyebrow>
              </div>
            </FadeUp>
            ...
            <FadeUp delay={0.2}>
              {/* leading-[1.8]로 두 줄 사이의 간격을 대폭 확장 (답답함 해소) */}
              <Heading level={1} align="left" className="text-3xl lg:text-5xl xl:text-6xl font-black tracking-tighter leading-[1.8] m-0">
                전국을 연결하는 <br />
            ...
            <FadeUp delay={0.3}>
              {/* mt-14로 제목과의 간격 확보, gap-5로 본문 줄 간격 확장 */}
            ...
            <FadeUp delay={0.7}>
              <div className="mt-14">
                <Link 
                  href="#quick-access" 
                  className="inline-flex items-center gap-2 rounded-full bg-brand-accent px-8 py-4 text-sm font-black text-brand-dark transition-all hover:scale-105 shadow-[0_10px_30px_rgba(206,255,0,0.15)]"
                >
                  서비스 시작하기 <span>→</span>
                </Link>
              </div>
