...
const items: StatItem[] = [
  {
    label: "활동 라이더",
    value: "1,500+",
    desc: `초창기 배달 플랫폼 시절부터 운영된 네트워크를 기반으로
지속적으로 성장해 온 장기 활동 라이더 그룹입니다.
쿠팡이츠플러스 초창기 ‘이츠특공대’ 운영 경험을 포함해
출고·교육·정산 체계를 직접 구축해 온 1세대 운영팀이 관리합니다.
현재는 수도권·광역권 중심으로 전국 단위로 확장되어
