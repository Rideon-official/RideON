...
type Card = {
  ...
  desc: string;
  href: string;
  // 카드 배경/테두리/아이콘 색을 카드별로 지정
  bg: string;        // ex) "bg-[#0E5AA7]"
  ring: string;      // ex) "ring-[#0E5AA7]"
...
const cards: Card[] = [
  {
    ...
    href: "/about",
    bg: "bg-[#0E5AA7]", ring: "ring-[#0E5AA7]", text: "text-white",
    icon: (
  ...
  },
  {
    ...
    href: "/bike#rent",
    bg: "bg-[#0597D5]", ring: "ring-[#0597D5]", text: "text-white",
    icon: (
      <svg viewBox="0 0 24 24" width="44" height="44" aria-hidden>
  ...
  },
  {
    ...
    bg: "bg-[#07B3D9]", ring: "ring-[#07B3D9]", text: "text-white",
    icon: (
      <svg viewBox="0 0 24 24" width="44" height="44" aria-hidden>
  ...
  },
  {
    ...
    href: "/store",
    bg: "bg-[#06C4D9]", ring: "ring-[#06C4D9]", text: "text-white",
    icon: (
      <svg viewBox="0 0 24 24" width="44" height="44" aria-hidden>
    ...
    <section className="relative">
      ...
      <div className="relative overflow-hidden bg-[#111111]">
        <div className="absolute inset-0">
          {/* 배경 사진: /public/hero/services-hero.jpg 넣어줘 */}
          <Image
            ...
            {cards.map((c, i) => (
              <article
                ...
                className={[
                  ...
                  c.bg,
                  c.text,
                  // 카드 사이 경계 없이 “붙어” 보이도록 둥근 모서리는 양 끝만
