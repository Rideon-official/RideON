// src/components/center/ServiceCenters.tsx
"use client";
...
function gmapEmbedSrc(q: string) {
  return `https://www.google.com/maps?q=${encodeURIComponent(q)}&output=embed`;
}
function gmapDirectionsHref(q: string) {
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div className="rounded-2xl border border-neutral-800 bg-neutral-900/40 p-5">
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <a
                ...
                className="inline-flex items-center rounded-xl bg-brandYellow px-4 py-2 font-semibold text-black hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-brandYellow/40"
              >
                전화하기
              </a>
              <a
                href={gmapDirectionsHref(current.mapQuery)}
                target="_blank"
          ...
          <div className="rounded-2xl overflow-hidden border border-neutral-800 bg-neutral-900/40">
            <iframe
              ...
              src={gmapEmbedSrc(current.mapQuery)}
